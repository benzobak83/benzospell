...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "html{font-family:\"Open Sans\",sans-serif}.title{font-size:40px;margin-bottom:40px;color:#0a1524;font-weight:bold;text-align:center}.wrapper{max-width:1440px;margin:0 auto}.line{width:66px;height:6px;margin:0 auto 55px;background:#399fdb}.row{display:flex;flex-wrap:wrap;justify-content:center;color:#0a1524}", ""]);
// Exports
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "html{font-family:\"Open Sans\",sans-serif}.header{display:flex;justify-content:space-between;height:75px;max-height:75px;width:100%;align-items:center;position:relative;border-bottom:1.5px solid #868686;box-shadow:rgba(0,0,0,.35) 0px 5px 15px}.header__logo{max-height:100%;margin-left:30px;cursor:pointer}.header__logo .header__img-logo{max-height:60px;max-width:145px;height:60px;width:145px}.header__ul{display:flex}.header__ul .header__li{box-sizing:border-box;display:flex;align-items:center;font-size:20px;font-weight:bold;height:76px;min-width:100px;color:rgba(0,0,0,.842);transition:.2s;cursor:pointer;border:2px solid rgba(0,0,0,0);padding:0px 20px}.header__ul .header__li:not(.header__li_active):hover{border-bottom:2px solid #e29a48;color:#4c707a}.header__ul .header__li:not(:last-child){margin-right:50px}.header__ul .header__li_active{border-bottom:2px solid #e29a48}.header__settings{display:flex;max-height:100%;align-items:center}.header__settings .header__language{margin-right:30px;cursor:pointer}.header__settings .header__language:hover .header__arrow-down{transform:rotate(185deg)}.header__settings .header__language .header__arrow-down{margin-left:5px;transition:all .3s;height:12px}.header__settings .header__menu-btn{display:none}.header__settings .header__menu-btn .header__img-menu{position:absolute;right:15px;top:50%;transform:translate(0, -50%);max-width:30px}.icon-flags_ru{background-image:url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");width:23px;height:15px;display:inline-block;vertical-align:middle;background-position:-46px -15px}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".guide{background:#f8f8f8}.guide__inner{display:flex;flex-direction:column;align-items:center;justify-content:space-between}.guide__title{margin-top:40px}.guide__item{transition:all .3s;border-radius:4px;box-sizing:border-box;padding-top:20px;text-align:center;flex:0 1 24%;margin-bottom:10px}.guide__item:not(:last-child){margin-right:10px}.guide__item:hover{background-color:#fff;box-shadow:2px 2px 2px 2px rgba(0,0,0,.04)}.guide__item .guide__img{height:89px;margin-bottom:25px}.guide__item .guide__descr{color:dimgray;line-height:1.4;display:flex;align-items:center;justify-content:center;flex-direction:column;height:92px;width:80%;margin:0 auto}", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
